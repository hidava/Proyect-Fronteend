...
export async function POST(request) {
  try {
    ...
    console.log('[auth login POST] EXTERNAL_API:', EXTERNAL_API);
    
    if (!EXTERNAL_API) {
      console.error('[auth login POST] EXTERNAL_API_BASE no configurado');
    ...
    console.log('[auth login POST] Calling:', apiUrl);
    ...
    console.log('[auth login POST] Response status:', res.status);
